...
const store = async (req, res) => {
    const { name, color, greetingMessage, outOfHoursMessage, schedules, chatbots, orderQueue, tempoRoteador, ativarRoteador, integrationId, fileListId, closeTicket } = req.body;
