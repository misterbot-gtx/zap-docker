...
const update = async (req, res) => {
    ...
    const { name, users, connections, queues, amount, useWhatsapp, useFacebook, useInstagram, useCampaigns, useSchedules, useInternalChat, useExternalApi, trial, trialDays, recurrence, useKanban, useIntegrations, useOpenAi } = planData;
    const plan = await (0, UpdatePlanService_1.default)({
        id,
        name,
        users,
        connections,
