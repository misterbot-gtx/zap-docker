...
const QueueIntegrationController = __importStar(require("../controllers/QueueIntegrationController"));
const queueIntegrationRoutes = (0, express_1.Router)();
...
queueIntegrationRoutes.post("/queueIntegration/testsession", isAuth_1.default, QueueIntegrationController.testSession);
