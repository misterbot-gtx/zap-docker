...
const useStyles = makeStyles((theme) => ({
  ...
  submitBtn: {
    marginTop: "20px",
    backgroundColor: "#007BFF", // Cor azul para o botão "Entrar"
    color: "#fff",
    borderRadius: "8px",
    padding: "12px",
    fontWeight: "bold",
    ...
    "&:hover": {
      backgroundColor: "#0056b3", // Tom mais escuro de azul para o hover
      boxShadow: "0px 4px 12px rgba(0, 0, 0, 0.2)",
    },
  },
  registerBtn: {
    backgroundColor: "#28a745", // Cor verde para o botão "Cadastre-se"
    color: "#fff",
    borderRadius: "8px",
    padding: "12px",
    fontWeight: "bold",
    ...
    "&:hover": {
      backgroundColor: "#218838", // Tom mais escuro de verde para o hover
      boxShadow: "0px 4px 12px rgba(0, 0, 0, 0.2)",
    },
  },
  whatsappButton: {
    ...
    <>
      ...
      <div className={classes.root}>
        ...
        <div
          ...
          onClick={() => window.open("https://wa.me/558893498100")}
        >
          <img 
