...
const useStyles = makeStyles((theme) => ({
  ...
  imageSide: {
    flex: 1,
    background: `url('https://i.ibb.co/fV0s1LFX/Gemini-Generated-Image-jsa23ajsa23ajsa2.png') no-repeat center center`,
  ...
  submitBtn: {
    marginTop: "20px",
    backgroundColor: "#007BFF",  // Cor alterada para #007BFF (azul claro)
    color: "#fff",
    borderRadius: "8px",
    padding: "12px",
    fontWeight: "bold",
    ...
    "&:hover": {
      backgroundColor: "#0056b3",  // Cor de hover ajustada para #0056b3 (azul escuro)
  ...
  loginBtn: {
    marginTop: "10px",
    backgroundColor: "#28a745",  // Cor alterada para #28a745 (verde médio)
    ...
    transition: "all 0.3s ease",
    "&:hover": {
      backgroundColor: "#218838", // Cor de hover ajustada para #218838 (verde escuro)
      color: "#fff", // Mantém a cor branca no hover
      borderColor: "#28a745", // Cor da borda ajustada
      boxShadow: "0px 4px 12px rgba(0, 0, 0, 0.1)",
    },
